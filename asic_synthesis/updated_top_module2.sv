module updated_top_module2 #(
    ...
    assign stall = (mem_read | mem_write) & is_peripheral_access & (~axi_done);
    ...
    always_comb begin
        if (alu_src_a == 2'b01) alu_operand_a = pc_current;
        else if (alu_src_a == 2'b10) alu_operand_a = 32'b0;
        else alu_operand_a = read_data1;
    end
